...
<template>
  <div class="min-h-screen bg-gray-50 p-6">
    ...
    <div class="flex gap-6 border-b mb-6">
      <button 
        v-for="(title, id) in store.headings.tabs" 
        :key="id"
        @click="currentTab = id"
        :class="[
          'pb-4 px-2',
          currentTab === id ? 'border-b-2 border-blue-600 text-blue-600 font-medium' : 'text-gray-600'
        ]"
      >
        {{ title }}
      </button>
    ...
    <template v-else-if="currentTab === 'resume'">
      <Resume />
    </template>
      ...
      <div class="grid grid-cols-3 gap-6">
        ...
        <div class="col-span-2 space-y-6">
          ...
          <div class="bg-white rounded-lg shadow p-6">
            <div class="grid grid-cols-2 mb-6">
              <h2 class="text-base font-medium text-gray-800">{{ store.headings.main.candidate.title }}</h2>
              <h3 class="text-base font-medium text-gray-800">{{ store.headings.main.candidate.subHeadings.keyHighlights }}</h3>
            </div>
          ...
          <!-- AI Recommendations -->
          <div class="bg-white rounded-lg shadow p-6">
            <h2 class="text-lg font-semibold mb-4">{{ store.headings.main.ai.title }}</h2>
            <div class="space-y-3">
              <div 
          ...
          <!-- Skill Gaps -->
          <div class="bg-white rounded-lg shadow p-6">
            <h2 class="text-lg font-semibold mb-4">{{ store.headings.main.skills.title }}</h2>
            <div class="space-y-4">
              <div 
        ...
        <div class="space-y-6">
          ...
          <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="mb-6">
              <div class="text-sm text-gray-600 mb-1">{{ store.headings.main.insights.subHeadings.confidence }}</div>
            ...
            <div class="space-y-4">
              <div>
                <h3 class="font-medium mb-2">{{ store.headings.main.insights.subHeadings.strengths }}</h3>
                <div class="space-y-2">
                  <div 
              ...
              <div>
                <h3 class="font-medium mb-2">{{ store.headings.main.insights.subHeadings.areas }}</h3>
                <div class="space-y-2">
                  <div 
          ...
          <!-- Quick Actions -->
          <div class="bg-white rounded-lg shadow p-6">
            <h2 class="text-lg font-semibold mb-4">{{ store.headings.main.actions.title }}</h2>
            <div class="space-y-3">
              <button
          ...
          <!-- Timeline -->
          <div class="bg-white rounded-lg shadow p-6">
            <h2 class="text-lg font-semibold mb-4">{{ store.headings.main.timeline.title }}</h2>
            <div class="space-y-4">
              <div 
